package com.ywf.ywfpicturebackend.shared.auth;
...
import com.ywf.ywfpicturebackend.domain.user.entity.auth.SpaceUserAuthConfig;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionsByRole(String spaceUserRole) {
        ...
        // 找到匹配的角色
        CommonRole role = SPACE_USER_AUTH_CONFIG.getRoles().stream()
